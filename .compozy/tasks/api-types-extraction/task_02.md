---
status: completed
title: Verify API type extraction
type: test
complexity: low
dependencies:
  - task_01
...
# Task 2: Verify API type extraction
...
- [x] 2.3 Run E2E.
- [x] 2.4 Validate Compozy metadata.
...
- `npm.cmd run test:e2e` passed with 2 tests.
- `compozy.cmd tasks validate --name api-types-extraction` passed with 2 scanned tasks.
