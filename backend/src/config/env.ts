...
const EnvSchema = z.object({
  ...
  AI_PROVIDER: z.enum(["google", "xai", "multi", "mock"]).default("google"),
  ...
  XAI_MODEL_CASCADE: z.string().default("grok-4-1-fast-non-reasoning,grok-4-fast-non-reasoning,grok-3-mini,grok-3"),
